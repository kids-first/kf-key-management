...
public enum Provider {
    ...
    public String getClientId()     { return env.getProperty(this.getApplicationEnvKey("client_id")); }
    public String getClientSecret() { return env.getProperty(this.getApplicationEnvKey("client_secret")); }
    public String getEndpoint()     { return env.getProperty(this.getApplicationEnvKey("token_endpoint")); }
    public String getRedirectUri()  { return env.getProperty(this.getApplicationEnvKey("redirect_uri")); }
    public String getScope()        { return env.getProperty(this.getApplicationEnvKey("scope")); }
